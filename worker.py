...
def add_worker(arquive_name):
    # Dados Empresa 
    workers = [
        # Nome/CPF/cargo/endereco/salario/genero/nascimento
        "João, 324.345.678-89, Gerente, Rua D, 8.0000, M, 09/03/1979\n",
        "Maria, 234.765.356-98, Analista, Rua Felizberto, 12.0000, F, 23/12/2003\n",
        "Pedro, 924.275.634-73, Supervisor, Rua Felizberto, 9.0000, M, 23/12/2003\n"
    ]
...
def update_worker(arquive_name, name, cpf, position, address, salary, gender, birth):
    # Dados a serem adicionados
    new_info = f"{name}, {cpf}, {position}, {address}, {salary}, {gender}, {birth}\n"
...
# Exemplo de uso
update_worker('workers.txt', 'Ana', "765.234.356-98", "Gerente", "Rua Farias", "14.000", "F", "23/12/2003")
    ...
    try:
        with open(arquive_name, 'r', encoding='utf-8') as arquive:
            ...
            for line in lines:
                ...
                print(f'Nome: {name}, CPF: {cpf}, Cargo:{position}, Endereco: {address}, Salario: {salary}, Genero: {gender}, Nascimento: {birth}')
